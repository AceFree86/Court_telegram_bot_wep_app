...
class UkrainianStemmer:
    def __init__(self, word):
        ...
        self.noun = r"(а|ев|ов|е|ями|ами|еи|и|ей|ой|ий|й|иям|ям|ием|ем|ам|ом|о|у|ах|иях|ях|ы|ь|ию|ью|ю|ия|ья|я|і|ові" \
                    r"|ї|ею|єю|ою|є|еві|ем|єм|ів|їв|ю)$"
    ...
    def search_preprocess(self, word):
        word = word.lower()
        word = word.replace("'", "")
    ...
    def stem_word(self):
        word = self.search_preprocess(self.word)
